...
[How long does it take to upgrade an eBook?](https://lobste.rs/s/gk3luv/how_long_does_it_take_upgrade_ebook)

[ARIA: aria-controls attribute](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-controls)

[ARIA: aria-owns attribute](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-owns)
...
[ARIA: aria-expanded attribute](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-expanded)

[ARIA: region role](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Roles/region_role)

[things that are difficult to implement accessibly](https://bsky.app/profile/sarasoueidan.com/post/3mevwqofsmc2w)

> CSS-only interactive solutions are OFTEN not accessible, such as this checkbox example in the article linked above. However, the popover attribute is a native HTML feature that browsers have implemented some accessibility into. You still have work to do on your end too.

> FWIW The alternative would be a custom disclosure widget (basically custom implementation of what the popover attribute offers) using <button>, ARIA, and a little bit of JS.

[Game Accessibility Guidelines](https://gameaccessibilityguidelines.com/)

[Death to Scroll Fade](https://lobste.rs/s/bi9wsi/death_scroll_fade)

[apple](https://news.ycombinator.com/item?id=48192224)
